...
--- ALL THE NEW UPDATES TOWARDS THE BOTTOM ---
...
----- locate products that have 5 plus stars, in addition with the combination 
---- of two tables ----- 

select productName, productType, productRating, emi.empName 
from product pji
